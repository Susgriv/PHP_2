...
class Request
{
	...
	// Например, для http://example.com/some/page?x=1&y=acb путём будет строка '/some/page'
	/**
	 * @throws HttpException
	 */
	...
	// Например, для http://example.com/some/page?x=1&y=acb значением параметра x будет строка '1'
	/**
	 * @throws HttpException
	 */
